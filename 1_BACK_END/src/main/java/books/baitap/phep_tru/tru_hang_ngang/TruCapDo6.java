...
public class TruCapDo6 {
    public static void main(String[] args) throws IOException {
        ...
        FileOutputStream out = new FileOutputStream("TruCapDo6.docx");

        generateSubtractionExercises(document, "Bài tập: Phép trừ 2 số có 2 chữ số trong phạm vi 30 (không nhớ)", 240);

        document.write(out);
        out.close();
        document.close();
        System.out.println("✅ Đã tạo xong file Word: TruCapDo6.docx");
    }
    ...
    private static void generateSubtractionExercises(XWPFDocument doc, String title, int totalCount) {
        ...
        while (problems.size() < totalCount) {
            int a = rand.nextInt(21) + 10;   // số bị trừ từ 10 → 30
            int b = rand.nextInt(21) + 10;   // số trừ từ 10 → 30
