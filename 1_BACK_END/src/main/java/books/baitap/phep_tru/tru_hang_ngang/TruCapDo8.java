...
public class TruCapDo8 {
    public static void main(String[] args) throws IOException {
        ...
        FileOutputStream out = new FileOutputStream("TruCapDo8.docx");

        generateSubtractionExercises(document, "Bài tập: Phép trừ 2 số có 2 chữ số trong phạm vi 100 (có nhớ)", 240);

        document.write(out);
        out.close();
        document.close();
        System.out.println("✅ Đã tạo xong file Word: TruCapDo8.docx");
    }
