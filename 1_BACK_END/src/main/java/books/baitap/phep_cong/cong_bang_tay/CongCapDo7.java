...
public class CongCapDo7 {
    public static void main(String[] args) throws IOException {
        ...
        FileOutputStream out = new FileOutputStream("CongCapDo7.docx");

        generateAdditionExercises(document, "Bài tập: Cộng 2 số trong phạm vi 100 (không nhớ)", 240);

        document.write(out);
        out.close();
        document.close();
        System.out.println("✅ Đã tạo xong file Word: CongCapDo7.docx");
    }
