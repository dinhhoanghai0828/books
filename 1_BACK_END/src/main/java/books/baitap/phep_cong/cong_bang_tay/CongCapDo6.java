...
public class CongCapDo6 {
    public static void main(String[] args) throws IOException {
        ...
        FileOutputStream out = new FileOutputStream("CongCapDo6.docx");

        generateAdditionExercises(document, "Bài tập: Cộng 2 số có 2 chữ số (10-20), tổng ≥ 30", 240);

        document.write(out);
        out.close();
        document.close();
        System.out.println("✅ Đã tạo xong file Word: CongCapDo6.docx");
    }
