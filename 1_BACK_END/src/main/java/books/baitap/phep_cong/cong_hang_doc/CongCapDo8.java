...
public class CongCapDo8 {
    public static void main(String[] args) throws IOException {
        ...
        FileOutputStream out = new FileOutputStream("CongCapDo8_HangDoc.docx");

        generateAdditionExercises(document,
                "Bài tập: Cộng 2 số trong phạm vi 100 (có nhớ, trình bày theo cột dọc)",
                240);

        document.write(out);
        out.close();
        document.close();
        System.out.println("✅ Đã tạo xong file Word: CongCapDo8_HangDoc.docx");
    }
    ...
    private static void generateAdditionExercises(XWPFDocument doc, String title, int totalCount) {
        ...
        // Mỗi trang 20 phép tính (vì hàng dọc chiếm chỗ)
        int perPage = 20;
