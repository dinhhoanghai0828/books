...
public class CongHangNgang {

    public static void main(String[] args) throws IOException {
        generate(1, "CongCapDo1.docx", "Cộng 2 số (tổng ≤ 10)", 240);
        generate(2, "CongCapDo2.docx", "Cộng 2 số (tổng > 10)", 240);
        generate(3, "CongCapDo3.docx", "1 chữ số + 2 chữ số (tổng < 20)", 240);
        generate(4, "CongCapDo4.docx", "1 chữ số + 2 chữ số (tổng ≥ 20)", 240);
        generate(5, "CongCapDo5.docx", "2 số (10–20), tổng < 30", 240);
        generate(6, "CongCapDo6.docx", "2 số (10–20), tổng ≥ 30", 240);
        generate(7, "CongCapDo7.docx", "2 số ≤ 100 (không nhớ)", 240);
        generate(8, "CongCapDo8.docx", "2 số ≤ 100 (có nhớ)", 240);
    }
