...
public class SoLonNhatCapDo1 {
    public static void main(String[] args) throws IOException {
        XWPFDocument document = new XWPFDocument();
        FileOutputStream out = new FileOutputStream("SoLonNhat_CapDo1.docx");

        addExercise(document, "Bài tập: Tìm số lớn nhất - Cấp độ 1", 2, 50, 0);

        document.write(out);
        out.close();
        document.close();
        System.out.println("✅ Đã tạo file SoLonNhat_CapDo1.docx");
    }
