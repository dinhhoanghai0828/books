...
public class SoLonNhatCapDo5 {
    public static void main(String[] args) throws IOException {
        XWPFDocument document = new XWPFDocument();
        FileOutputStream out = new FileOutputStream("SoLonNhat_CapDo5.docx");

        addExercise(document, "Bài tập: Tìm số lớn nhất - Cấp độ 5", 6, 50, 1000);

        document.write(out);
        out.close();
        document.close();
        System.out.println("✅ Đã tạo file SoLonNhat_CapDo5.docx");
    }
