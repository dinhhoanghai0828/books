...
const AudioLayout: React.FC<AudioLayoutProps> = ({
  ...
  useEffect(() => {
    ...
    // Throttle viec update active item de giam re-render
    ...
    const attach = () => {
      ...
      const onTimeUpdate = () => {
        ...
        // Throttle viec highlight cau dang chay de giam re-render
        const now = Date.now();
        ...
        // Highlight cau dang chay theo currentTime - chi update khi thay doi
